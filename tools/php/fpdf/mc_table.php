...
{
    private $_totalPages = 0; // Propiedad privada para almacenar el total de páginas
    protected $widths;
    protected $aligns;
    ...
    function Row($data,$_color_=null){
...
/* no funciono
    // Sobrecargar el método Footer() para actualizar el total de páginas
    function Footer() {
        //if ($this->PageNo() == $this->AliasNbPages) {
            $this->_totalPages = $this->PageNo(); // Almacenamos el número total de páginas
        //}
    }
    public function setTotalPages($total) {
        $this->_totalPages = $total;
    }
    // Método público para obtener el total de páginas
