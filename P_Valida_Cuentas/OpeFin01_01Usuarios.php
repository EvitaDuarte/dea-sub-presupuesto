                            ...
                            <div class="wrapper">
                                <section class="seccion_caja_despliegue" id="secCap">
                                    <div class="caja_captura">
                                        ...
                                        maxlength=30 onkeyup="this.title=this.value;" onblur="valida_LdapUsu();">
                                    </div>
...
<!--    El filemtime asegura que se vuelva a cargar el JS solo si este se modifico, evitando tener que borrar cookies -->
        <script src="jsF/backspace_.js?v=<?php echo filemtime('jsF/backspace_.js'); ?>"></script>
        <script src="jsF/cerrarSesion_.js?v=<?php  echo filemtime('jsF/cerrarSesion_.js'); ?>"></script>
        <script src="jsF/rutinas_.js?v=<?php  echo filemtime('jsF/rutinas_.js'); ?>"></script>
        <script src="jsF/Usuarios_.js?v=<?php echo filemtime('jsF/Usuarios_.js'); ?>"></script>
    </body>
</html>